<p>Please follow this link to login to your account: <?php echo html::anchor($validationUrl) ?></p>
<p>Or enter the code: <b><?php echo $validationCode ?></b></p>

<p>Once logged in, you can change your password by going the 'My Account' page</p>
